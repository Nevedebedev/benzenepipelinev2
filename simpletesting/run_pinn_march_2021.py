"""
Run PINN prediction on March 2021 data using EXACT benchmark methodology
"""
...
# Paths
MARCH_2021_DIR = "/Users/neevpratap/Desktop/madis_data_desktop_updated/training_data_2021_march_REPAIRED"
...
print("="*70)
print("PINN PREDICTION - MARCH 2021")
print("="*70)
...
facilities = {}
for fpath in glob.glob(os.path.join(MARCH_2021_DIR, "*_training_data.csv")):
...
# Save
output_path = os.path.join(OUTPUT_DIR, "sensors_pinn_benzene_ppb_2021_march.csv")
print(f"\n[5/5] Saving results...")
