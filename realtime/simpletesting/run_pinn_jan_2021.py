"""
Run PINN prediction on January 2021 data using EXACT benchmark methodology

Following exact_nn2_training_data_specs.md specifications
"""
...
# Paths
JAN_2021_DIR = "/Users/neevpratap/Desktop/madis_data_desktop_updated/training_data_2021_full_jan_REPAIRED"
OUTPUT_DIR = "/Users/neevpratap/simpletesting"
BASE_DIR = "/Users/neevpratap/simpletesting"

# Sensor coordinates from spec (line 296-306)
SENSORS = {
...
print("="*70)
print("PINN PREDICTION - JANUARY 2021")
print("="*70)
...
facilities = {}
for fpath in glob.glob(os.path.join(JAN_2021_DIR, "*_training_data.csv")):
...
# Save
output_path = os.path.join(OUTPUT_DIR, "sensors_pinn_benzene_ppb_2021_jan.csv")
print(f"\n[5/5] Saving results...")
