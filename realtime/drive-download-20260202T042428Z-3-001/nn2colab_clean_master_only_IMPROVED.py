"""
NN2 Training Script for Colab - Master Model Only (IMPROVED VERSION)
...
- Stronger regularization: lambda_correction 0.001 → 0.01
- Added large correction penalty: lambda_large = 0.1
- Better early stopping with min_delta
- Comprehensive logging with correction statistics
...
def correction_loss(pred, target, corrections, valid_mask, lambda_correction=0.01, 
    ...
    Args:
        ...
        lambda_correction: Regularization weight (default: 0.01, increased from 0.001)
...
# ═══════════════════════════════════════════════════════════════════
# 5. MASTER MODEL TRAINING (ALL SENSORS) - IMPROVED VERSION
# ═══════════════════════════════════════════════════════════════════
...
def train_master_model():
    ...
    print("="*80)
    print("NN2 TRAINING - MASTER MODEL ONLY (ALL SENSORS) - IMPROVED VERSION")
    print("="*80)
...
if __name__ == '__main__':
    ...
    print("="*80)
    print(f"\nFiles saved:")
    print(f"  • Master model: {CONFIG['save_dir']}/nn2_master_model_ppb-3.pth")
    print(f"  • Scalers: {CONFIG['save_dir']}/nn2_master_scalers-3.pkl")
    print("="*80)
